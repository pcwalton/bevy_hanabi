...
impl EffectsMeta {
    pub fn new(
        ...
        Self {
            ...
            indexed_indirect_draw_command_buffer: RawBufferVec::new(BufferUsages::STORAGE),
            non_indexed_indirect_draw_command_buffer: RawBufferVec::new(BufferUsages::STORAGE),
            gpu_limits,
            indirect_shader_noevent,
            indirect_shader_events,
            render_batch_shader,
